...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { invited_guest_name: @rsvp.invited_guest_name, meal: @rsvp.meal, plus_one?: @rsvp.plus_one?, plus_one_name: @rsvp.plus_one_name }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { invited_guest_name: @rsvp.invited_guest_name, meal: @rsvp.meal, plus_one?: @rsvp.plus_one?, plus_one_name: @rsvp.plus_one_name }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
